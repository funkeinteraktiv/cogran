...
function binaryDasymetricMappingRelative(source, target, options, progress) {
...
function intersect(a, b) {
  ...
  a.features.forEach((d, i) => {
    Logger.info(`[binaryDasymetricMappingRelative][intersect][${i}/${a.features.length}]`);
...
module.exports = binaryDasymetricMappingRelative;
