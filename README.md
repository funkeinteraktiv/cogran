...
&nbsp;&nbsp;&nbsp; for absolute values (e.g. 560 voters):
```
...
&nbsp;&nbsp;&nbsp; for relative & average values (e.g. 20 % of all voters, 32.000 € average income, ...):
```
...
&nbsp;&nbsp;&nbsp; for relative values related to absolute values (e.g. 20 % of 560 voters):
```
